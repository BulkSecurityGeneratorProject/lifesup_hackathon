...
public class CompanyResourceIntTest {
    ...
    private static final String DEFAULT_FULL_ADDRESS = "AAAAA";
    private static final String UPDATED_FULL_ADDRESS = "BBBBB";
    ...
    public void createCompany() throws Exception {
        ...
        assertThat(testCompany.getFullAddress()).isEqualTo(DEFAULT_FULL_ADDRESS);
    ...
    public void updateCompany() throws Exception {
        ...
        assertThat(testCompany.getFullAddress()).isEqualTo(UPDATED_FULL_ADDRESS);
