(function () {
    ...
    WorkspaceController.$inject = ['$scope', '$state', '$http', '$stateParams', 'entity', 'application', 'WorkspaceOfChallenge', 'ApplicationByChallengeId'];

    function WorkspaceController($scope, $state, $http, $stateParams, entity, application, WorkspaceOfChallenge, ApplicationByChallengeId) {
        var vm = this;
