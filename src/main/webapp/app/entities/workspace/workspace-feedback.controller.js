(function () {
    ...
    WorkspaceFeedbackController.$inject = ['$scope', 'application', 'entity', '$state', '$stateParams', 'ChallengeWorkspaceFeedback', '$mdDialog'];

    function WorkspaceFeedbackController($scope, application, entity, $state, $stateParams, ChallengeWorkspaceFeedback, $mdDialog) {
        var vm = this;
