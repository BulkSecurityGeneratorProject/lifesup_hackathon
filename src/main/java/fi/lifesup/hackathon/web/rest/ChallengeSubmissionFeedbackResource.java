...
public class ChallengeSubmissionFeedbackResource {
     ...
     *
     * @param challengeSubmissionFeedback the challengeSubmissionFeedback to create
     * @return the ResponseEntity with status 201 (Created) and with body the new challengeSubmissionFeedback, or with status 400 (Bad Request) if the challengeSubmissionFeedback has already an ID
    ...
    /**
     * PUT  /challenge-submission-feedbacks : Updates an existing challengeSubmissionFeedback.
     *
     * @param challengeSubmissionFeedback the challengeSubmissionFeedback to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated challengeSubmissionFeedback,
     * or with status 400 (Bad Request) if the challengeSubmissionFeedback is not valid,
     * or with status 500 (Internal Server Error) if the challengeSubmissionFeedback couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/challenge-submission-feedbacks")
    @Timed
    public ResponseEntity<ChallengeSubmissionFeedback> updateChallengeSubmissionFeedback(@RequestBody ChallengeSubmissionFeedback challengeSubmissionFeedback) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("challengeSubmissionFeedback", challengeSubmissionFeedback.getId().toString()))
            .body(result);
    }

    /**
     * GET  /challenge-submission-feedbacks : get all the challengeSubmissionFeedbacks.
     *
     * @return the ResponseEntity with status 200 (OK) and the list of challengeSubmissionFeedbacks in body
     */
    ...
    /**
     * GET  /challenge-submission-feedbacks/:id : get the "id" challengeSubmissionFeedback.
     *
     * @param id the id of the challengeSubmissionFeedback to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the challengeSubmissionFeedback, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /challenge-submission-feedbacks/:id : delete the "id" challengeSubmissionFeedback.
     *
     * @param id the id of the challengeSubmissionFeedback to delete
